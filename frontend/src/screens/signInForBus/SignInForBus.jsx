...
const SignInForBus = () => {
  ...
  const signUpButtonClicked = async () => {
    if (!email) {
      ...
      setLoading(true);
      await axios
        .post("http://localhost:4000/bus/loginBus", {
          email,
          password,
        })
        .then((res) => {
        ...
        <div className="signInBox">
          <div className="d-flex" style={{ height: "480px" }}>
            <div style={{ padding: "30px" }} className=" w-100">
              <div>
                <h2 className="header2 mb-2">Bus Login </h2>
